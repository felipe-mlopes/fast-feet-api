...
describe('Edit Order Status to Return (E2E)', () => {
  ...
  test('[PACTH] /orders/:orderId/return', async () => {
    ...
    expect(orderOnDatabase?.status).toEqual('WAITING');
    expect(orderOnDatabase?.isReturned).toEqual(true);
  });
});
